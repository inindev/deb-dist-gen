...
main() {
    local outdir='../target_nanopc-t6/dtb'
    ...
    local dts_files='rk3588-nanopc-t6'
    sed -i "s|<DTS_FILES>|$dts_files|" "$outfile"

    local dts_links='rk3588-nanopc-t6.dts rk3588.dtsi rk3588s.dtsi rk3588-pinctrl.dtsi rockchip-pinconf.dtsi'
